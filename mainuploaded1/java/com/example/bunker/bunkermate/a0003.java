...
public class a0003 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedpref2 = getSharedPreferences("daynum", Context.MODE_PRIVATE);
        editor2 = sharedpref2.edit();

        editor2.putInt("Sun", 10);
        editor2.putInt("Mon", 20);
        editor2.putInt("Tue", 30);
        editor2.putInt("Wed", 40);
        editor2.putInt("Thu", 50);
        editor2.putInt("Fri", 60);
        editor2.putInt("Sat", 70);
