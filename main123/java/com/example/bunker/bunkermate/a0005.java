...
public class a0005 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String s,sub;
        SharedPreferences sharedpref, sharedpref1, sharedpref3, sharedpref4,sharedpref7,sharedpref8, sharedprefa9;
        ...
        s = sharedpref7.getString("sub1", "");  p1.setText(sharedprefa9.getString(s, ""));
        s = sharedpref7.getString("sub2", "");  p2.setText(sharedprefa9.getString(s, ""));
        s = sharedpref7.getString("sub3", "");  p3.setText(sharedprefa9.getString(s, ""));
        s = sharedpref7.getString("sub4", "");  p4.setText(sharedprefa9.getString(s, ""));
        s = sharedpref7.getString("sub5", "");  p5.setText(sharedprefa9.getString(s, ""));
        s = sharedpref7.getString("sub6", "");  p6.setText(sharedprefa9.getString(s, ""));
        ...
        gd = (GradientDrawable) b1.getBackground().mutate();    gd.setColor(sharedpref3.getInt(sub + 1, 0));
        gd = (GradientDrawable) b2.getBackground().mutate();    gd.setColor(sharedpref3.getInt(sub + 2, 0));
        gd = (GradientDrawable) b3.getBackground().mutate();    gd.setColor(sharedpref3.getInt(sub + 3, 0));
        gd = (GradientDrawable) b4.getBackground().mutate();    gd.setColor(sharedpref3.getInt(sub + 4, 0));
        gd = (GradientDrawable) b5.getBackground().mutate();    gd.setColor(sharedpref3.getInt(sub + 5, 0));
        gd = (GradientDrawable) b6.getBackground().mutate();    gd.setColor(sharedpref3.getInt(sub + 6, 0));
    ...
    public void on_click_ck1(int i,View v) {
        ...
        if (firstTap == true && sharedpref13.getInt("but" + i, 0)!=Color.GRAY) {
            ...
            if (b_dr > 1) {
                ...
                editor8.putString(b_tmp, Float.toString(avg) + "%");
    ...
    public void on_click_ck2(int i,View v) {
        ...
        if (firstTap == true && sharedpref13.getInt("but" + i, 0)!=Color.WHITE) {
            ...
            Toast.makeText(this, "Inside ck21", Toast.LENGTH_SHORT).show();
        }
            ...
            Toast.makeText(this, "Inside ck22", Toast.LENGTH_SHORT).show();
        }
        editor5.apply();
        editor6.apply();
        editor8.apply();
