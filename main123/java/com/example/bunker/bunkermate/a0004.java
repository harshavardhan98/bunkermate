...
public class a0004 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String sub="but";
        SharedPreferences sharedpref8=getSharedPreferences("bunked_colors", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor8=sharedpref8.edit();
        editor8.putInt(sub+0,0);
        editor8.putInt(sub+1,0);
        editor8.putInt(sub+2,0);
        editor8.putInt(sub+3,0);
        editor8.putInt(sub+4,0);
        editor8.putInt(sub+5,0);
        editor8.putInt(sub+6,0);
        editor8.putInt(sub+7,0);
        editor8.apply();
        ...
        SharedPreferences sharedpref3=getSharedPreferences("first_tap", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor3=sharedpref3.edit();
        sub="but";
        editor3.putBoolean(sub+0,true);
        editor3.putBoolean(sub+1,true);
        editor3.putBoolean(sub+2,true);
        editor3.putBoolean(sub+3,true);
        editor3.putBoolean(sub+4,true);
        editor3.putBoolean(sub+5,true);
        editor3.putBoolean(sub+6,true);
        editor3.putBoolean(sub+7,true);
        editor3.apply();

        sharedpref3=getSharedPreferences("first_tap2", Context.MODE_PRIVATE);
        ...
        editor12.putInt("total_nr",0);
        editor12.putInt("total_dr",0);
        editor12.apply();
